...
- **Startup guardrails:** Increase `MIDDLEWARE_PLUGIN_TIMEOUT_MS` (default `60000`) when large datasets make schema checks slow so Fastify waits for the datastore plugin to finish instead of aborting early.
